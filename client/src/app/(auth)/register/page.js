...
const SignUp = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center px-4 md:px- bg-white text-foreground transition-colors duration-300 dark:bg-[#232326] dark:text-white">
